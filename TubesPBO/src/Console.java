...
public class Console {
    ...
    public void editKereta() {
        ...
        if(k == null) {
            ...
            if(k.getStatus()) {
                ...
                String nama; int cap;
                System.out.print("\nData Lama \n" +
                                 "Nama Kereta       : " + k.getNamaKereta() + "\n" +
                                 "Kapasitas Gerbong : " + k.getKapasitasGerbong() + "\n");
                System.out.print("Input Data Baru \n" + 
                                 "Nama Kereta       : "); nama = scanString.nextLine();
                System.out.print("Kapasitas Gerbong : "); cap = scanInt.nextInt();
                k.resetStatusGerbong();
                k.getDaftarGerbong().clear();
                k.setNamaKereta(nama); k.setKapasitasGerbong(cap);
    ...
    public void editGerbong(){
        ...
        if(g == null) {
            ...
            try {
                ...
                int tipe, kursi;
                System.out.print("\nData Lama \n" +
                        "Tipe Gerbong : " + g.getTipeGerbong() + "\n" +
                        "Jumlah Kursi : " + g.getJumlahKursi() + "\n" +
                        "Input Data Baru\n");
                ...
                id = app.generateIDGerbong(tipe);
                g.setIdGerbong(id);
                g.setTipeGerbong(tipe);
                g.setJumlahKursi(kursi);
    ...
    public void tambahTiket(){
        ...
        if((r != null) && (k != null) && !k.getDaftarGerbong().isEmpty()) {
    ...
    public void searchTiket(){
        ...
        if(r != null){
            ...
            if(t != null){
                ...
                System.out.println("Kereta : " + t.getKereta().getIdKereta());
    ...
    public void viewDaftar(ArrayList array) {
        if(array.get(0) instanceof Gerbong) {
            ...
            for(Gerbong g : arrayGerbong) {
                ...
                System.out.println(g.getIdGerbong() + " | " + tipe + " | " + g.getJumlahKursi() + " | " + status);
            }
        }
            ...
            for(Kereta k : arrayKereta) {
                System.out.println(k.getIdKereta() + " | " + k.getNamaKereta() + " | " + k.getDaftarGerbong().size() + " | " + k.getKapasitasGerbong());
            }
        }
            ...
            for(Rute r : arrayRute){
                System.out.println(r.getIdRute() + " | " + r.getStasiunAwal().getNamaStasiun() + " | " + r.getStasiunTujuan().getNamaStasiun() + " | " + r.getDistance());
            }
        }
            ...
            for(Stasiun s : arrayStasiun) {
                System.out.println(s.getIdStasiun() + " | " + s.getNamaStasiun() + " | " + s.getKota());
            }
        }
        if(array.get(0) instanceof Tiket) {
            ...
            for(Tiket t : arrayTiket) {
                System.out.println(t.getIdTiket() + " | " + t.getRute().getStasiunAwal().getKota() + "-" + t.getRute().getStasiunTujuan().getKota() + " | " + t.getHarga() + " | " + t.getKereta().getIdKereta() + " | " + t.getJadwal());
            }
        }
        System.out.println("\nSelesai...");
        scanString.nextLine();
