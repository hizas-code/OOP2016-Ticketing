 ...
 */
public class MenuEditTiket extends javax.swing.JPanel {

    public MenuEditTiket() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jadwalSpinner.setModel(new javax.swing.SpinnerDateModel(new java.util.Date(), new java.util.Date(1451581200000L), null, java.util.Calendar.DAY_OF_MONTH));
    ...
    public void setHarga(double s){
        hargaSpinner.setValue(s);
    }
    public void setJadwal(String s){
        jadwalSpinner.setValue(s);
    }
